...
class BundleManagerTest {
    ...
    fun continuesLoadingAfterOneBundleFails() {
        ...
        val manager = BundleManager(
            ...
            hostServicesFactory = org.shiyun.lapislazuli.runtime.core.host.HostServicesFactory { FakeHostServices() },
            logger = TestLogger(),
        )
    ...
    private class FakeHostServices : HostServices {
        ...
        override fun registerCommand(
            ...
            aliases: List<String>,
            execute: Callback,
        ) = org.shiyun.lapislazuli.runtime.core.host.Registration {}

        override fun registerEvent(eventKey: String, handler: Callback) =
            org.shiyun.lapislazuli.runtime.core.host.Registration {}

        override fun runNow(task: Callback) = org.shiyun.lapislazuli.runtime.core.host.TaskHandle {}

        override fun runLater(delayTicks: Long, task: Callback) =
            org.shiyun.lapislazuli.runtime.core.host.TaskHandle {}
